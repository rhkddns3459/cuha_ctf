...
module.exports = class First_blood extends Sequelize.Model {
  ...
  static init(sequelize) {
    return super.init(
      ...
      },
      {
        ...
        modelName: "First_blood", //모델 이름을 설정할 수있다
        tableName: "First_blood", //기본적으로 모델이름을 소문자및 복수형으로 만드는데 모델이 User면 users가된다
